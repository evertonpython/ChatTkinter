...
def conversa():
    print("Funcionou")
    resp = ['oie', 'tudo sim, e com você?', 'infelizmente kk', 'me pergunte algo...'] ###### RESPOSTAS RELATIVAS ÁS PERGUNTAS ########
    n2 = str(edEu.get())
    lb["text"] = resp
...
btSair = Button(janela, text="Sair",bg="red",fg="black", width=5, command=sair)
...
#                    CopyRight  Everton    01/06/2019        #
lbCred = Label(janela, text="by - Everton Sousa 2019", width=20, bg="black", fg="white")
